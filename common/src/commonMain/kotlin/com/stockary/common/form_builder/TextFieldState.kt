...
open class TextFieldState(
    ...
    internal fun validateEmail(message: String): Boolean {
        ...
        if (!validators.contains(Validators.Required()) && value.isEmpty()) {
            return true
        }
    ...
    internal fun validateWebUrl(message: String): Boolean {
        val webUrlRegex = "(https?://)?(www\\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\\.[a-z]{2,4}\\b([-a-zA-Z0-9@:%_+~#?&/=]*)"
